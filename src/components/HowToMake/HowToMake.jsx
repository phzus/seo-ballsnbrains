  ...
  return (
    <div id="how-it-works" className="bg-bb-dark">
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="max-w-[1140px] mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
          <div className="flex-1 order-2 md:order-1">
            <img
              src={benefit1}
              alt="Tastes like coffee"
              loading="lazy"
              className="w-full max-w-[480px] mx-auto md:mx-0 rounded-2xl object-cover"
            />
          </div>
          <div className="flex-1 order-1 md:order-2 flex flex-col gap-5">
            <LogoBadge />
            <h2 className="text-white text-[36px] md:text-[58px] font-bold leading-tight">
              Tastes like <span className="text-bb-gold italic font-bold">coffee.</span>
            </h2>
            <div className="text-bb-text-dim text-[16px] md:text-[23px] leading-relaxed space-y-4 font-medium">
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="max-w-[1140px] mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-20">
          <div className="flex-1 flex flex-col gap-5">
            <LogoBadge />
            <h2 className="text-white text-[36px] md:text-[58px] font-bold leading-tight">
              Works like a <span className="text-bb-gold italic font-bold">protocol.</span>
            </h2>
            <div className="text-bb-text-dim text-[16px] md:text-[23px] leading-relaxed space-y-4 font-medium">
      ...
      <section className="border-t border-bb-separator px-6 py-20 md:py-28">
        <div className="max-w-[1140px] mx-auto">
          <div className="mb-14 md:mb-20 text-center">
            <h2 className="text-white text-[32px] md:text-[55px] font-bold leading-tight">
              Here's What Happens<br />
              Inside <span className="text-bb-gold italic">Your Body</span>
            </h2>
            <p className="text-bb-text-dim text-[15px] md:text-[18px] leading-relaxed mt-4 max-w-[600px] mx-auto">
                ...
                >
                  <div className="flex-1 w-full">
                    <img
                      ...
                      alt={r.day}
                      loading="lazy"
                      className="w-full max-w-[500px] mx-auto rounded-2xl object-cover aspect-[4/3] border border-bb-gold-dark/40"
                    />
                  </div>
                  <div className="flex-1 flex flex-col gap-5">
                    <h3 className="text-bb-gold text-[36px] md:text-[48px] font-bold leading-none">
                      {r.day}
                    </h3>
                    <ul className="flex flex-col gap-3 text-bb-text-dim text-[14px] md:text-[16px] leading-relaxed">
                      {r.bullets.map((b, i) => (
                        <li key={i} className="flex gap-3">
                          <span className="text-bb-gold mt-[7px] shrink-0 inline-block w-1.5 h-1.5 rounded-full bg-bb-gold" />
                          <span>{b}</span>
                        </li>
                      ))}
                    </ul>
          ...
          <div className="mt-16 md:mt-20 flex flex-col items-center gap-3">
            ...
            <p className="text-bb-text-muted text-[14px] md:text-[15px] font-medium">
              ✅ 365-Days Guarantee.
            </p>
          </div>
        </div>
